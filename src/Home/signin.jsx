          ...
          <div style={styles.card}>
            ...
            <div style={{ ...styles.socialRow, position: 'relative', zIndex: 1 }}>
              <button
                ...
                onClick={() => { window.location.href = 'https://healthguide-backend.onrender.com/api/auth/google'; }}
              >
              ...
              <button
                ...
                className="social-btn"
                style={styles.socialBtn}
                onClick={() => { window.location.href = 'https://healthguide-backend.onrender.com/api/auth/github'; }}
              >
